...
public class Main {
	public enum Programs {
		...
		TORRENTWEB("torrents", "Extract torrents from http responses in warc (full crawl output) files.");
	...
	public static void main(String[] args) {
		...
		try {
			if (Programs.TORRENTWEB.getName().equals(tool)) {
				retval = ToolRunner.run(new Configuration(), new TorrentWeb(), toolArgs);
			} 
